/*
 * Test Oracle Class for heating.sensor.TempListenerImpl
...
import heating.sensor.TempListenerImpl_JML_Data.*;


/**
 * Test oracles generated by JMLUnitNG for OpenJML RAC of class
 * heating.sensor.TempListenerImpl.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2018-01-08 21:21 +0200
 */

public /*@ nullable_by_default */ class TempListenerImpl_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {TempListenerImpl_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(TempListenerImpl_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(heating.sensor.TempListenerImpl.class),
   ...
   *
   * @param heatingController The HeatingController to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_TempListenerImpl__HeatingController_heatingController__8")
  public void test_TempListenerImpl__HeatingController_heatingController__8
  (final heating.HeatingController heatingController) {
    try {
      new heating.sensor.TempListenerImpl(heatingController);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_TempListenerImpl__HeatingController_heatingController__8".equals($e.getStackTrace()[3].getMethodName())) {
  ...
  /**
   * A test for method onTempChange.
   *
   * @param the_test_object The TempListenerImpl to call the test method on.
   * @param temp The int to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_onTempChange__int_temp__0")
  public void test_onTempChange__int_temp__0
  (final heating.sensor.TempListenerImpl the_test_object, 
   final int temp) {
    ...
    try {
      the_test_object.onTempChange(temp);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_onTempChange__int_temp__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  /**
   * Data provider for constructor TempListenerImpl(HeatingController).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_TempListenerImpl__HeatingController_heatingController__8", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_TempListenerImpl__HeatingController_heatingController__8() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (TempListenerImpl__HeatingController_heatingController__8__heatingController.class));
  }


  /**
   * Data provider for method void onTempChange(int).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_onTempChange__int_temp__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_onTempChange__int_temp__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (TempListenerImpl_InstanceStrategy.class,
          onTempChange__int_temp__0__temp.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(TempListenerImpl_InstanceStrategy.class));
  }
}