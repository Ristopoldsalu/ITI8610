 ...
 * package-scope test values for type heating.HeatingController.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2018-01-08 21:21 +0200
 */
public /*@ nullable_by_default */ class PackageStrategy_heating_HeatingController 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type heating.HeatingController.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope heating.HeatingController values or generators here */ });
  }
   ...
   */
  public PackageStrategy_heating_HeatingController() {
