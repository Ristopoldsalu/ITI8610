 ...
 * package-scope test values for type lighting.sensor.LightListener.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2018-01-08 21:21 +0200
 */
public /*@ nullable_by_default */ class PackageStrategy_lighting_sensor_LightListener 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type lighting.sensor.LightListener.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope lighting.sensor.LightListener values or generators here */ });
  }
   ...
   */
  public PackageStrategy_lighting_sensor_LightListener() {
    super(lighting.sensor.LightListener.class);
    setReflective(false);
