/*
 * Test Oracle Class for lighting.light.LightImpl
...
import lighting.light.LightImpl_JML_Data.*;


/**
 * Test oracles generated by JMLUnitNG for OpenJML RAC of class
 * lighting.light.LightImpl.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2018-01-08 21:21 +0200
 */

public /*@ nullable_by_default */ class LightImpl_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {LightImpl_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(LightImpl_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(lighting.light.LightImpl.class),
  ...
  public void test_LightImpl__0
  () {
    try {
      new lighting.light.LightImpl();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_LightImpl__0".equals($e.getStackTrace()[3].getMethodName())) {
   ...
   *
   * @param the_test_object The LightImpl to call the test method on.
   * @param lux The int to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_update__int_lux__0")
  public void test_update__int_lux__0
  (final lighting.light.LightImpl the_test_object, 
   final int lux) {
    ...
    try {
      the_test_object.update(lux);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_update__int_lux__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  /**
   * Data provider for method void update(int).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_update__int_lux__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_update__int_lux__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (LightImpl_InstanceStrategy.class,
          update__int_lux__0__lux.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(LightImpl_InstanceStrategy.class));
  }
}